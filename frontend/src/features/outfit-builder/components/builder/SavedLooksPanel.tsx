...
export function SavedLooksPanel({
  ...
  return (
    <Card className="flex h-full min-h-0 flex-col border-[var(--border-strong)]" padding="sm">
      <div className="flex flex-none items-start justify-between gap-4 border-b border-[var(--border)] pb-4">
        <div>
      ...
      {saveState === 'saved' ? (
        <div className="mt-4 flex flex-none items-center gap-2 border border-[var(--border-strong)] bg-[var(--bg)] px-4 py-3 text-[11px] uppercase tracking-[0.18em] text-[var(--text-primary)]">
